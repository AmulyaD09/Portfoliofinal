...
function SkillCanvas() {
  ...
  return (
    <div className='flex md:flex-row flex-col justify-center items-center p-2 m-2 min-h-screen'>
      ...
      I'm a full-stack developer with a passion for building dynamic web applications.
        <span className="text-blue-400">
           I'm a quick learner and have a knack for picking up new technologies
          quickly.  With keyboard as my canvas and lines of code as my paint,
        </span>{" "}
       I'm eager to craft digital wonders and explore the world of technology.  How about teaming up and painting the future of Technology together? ^^
      </p>
